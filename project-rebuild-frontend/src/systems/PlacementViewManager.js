...
const DEFAULT_CONTINUE_BUTTON_TEXT = `시설 ${REQUIRED_PLACEMENTS}개 더 배치`;
...
export const PLACEMENT_UI_LAYOUT = {
  ...
  leftPanel: { x: 210, y: 540, width: 380, height: 1040, fillColor: 0x111827, alpha: 0.94, strokeColor: 0x60a5fa },
  title: { x: 40, y: 54, text: '건물 선택' },
  subtitle: { x: 40, y: 100, text: '샘플 3종 중 하나를 고른 뒤\n지도 위에 배치하세요.' },
  mission: { x: 40, y: 145, wordWrapWidth: 330 },
  buildingList: { x: 40, startY: 305, gapY: 160 },
  status: { x: 40, y: 815 },
  cursorInfo: { x: 40, y: 895, text: '커서 타일: 지도 위로 이동하세요.', wordWrapWidth: 320 },
  message: { x: 40, y: 980, text: '아직 배치된 건물이 없습니다.', wordWrapWidth: 325 },
  continueButton: { x: 1615, y: 985, width: 300, height: 72, text: DEFAULT_CONTINUE_BUTTON_TEXT, target: SCENE_KEYS.Result, backgroundColor: 0x94a3b8, alpha: 1, strokeColor: 0xe2e8f0 },
...
export const PLACEMENT_TEXT_STYLES = {
  ...
  status: { fontSize: '16px', color: '#f8fafc', lineSpacing: 3, wordWrap: { width: 330, useAdvancedWrap: true } },
