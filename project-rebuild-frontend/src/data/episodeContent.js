...
export const EP1_NEXT_MISSION = [
  ...
  '',
  '다음 화면에서 인구 유입 전략을 한 번 선택하고, 시설 배치로 상태 변화를 확인합니다.',
];
...
export const EP2_REFLECTION_CHOICES = [
  {
    id: 'population_economy',
    title: '일자리와 생활 기반의 연결',
    icon: '👥',
    description: '인구 회복에는 일자리뿐 아니라 생활 편의가 함께 필요하다는 점을 확인했다.',
    nextActionLabel: 'EP3 성장 관점',
    nextAction: 'EP3에서는 늘어난 일자리와 산업 활동이 지역 경제를 어떻게 바꾸는지 관찰합니다.',
    color: 0x38bdf8,
  },
  {
    id: 'mobility_welfare',
    title: '이동 접근성의 중요성',
    icon: '🚌',
    description: '교통과 생활 서비스 접근성이 주민의 정주 조건에 영향을 준다는 점을 확인했다.',
    nextActionLabel: 'EP3 성장 관점',
    nextAction: 'EP3에서는 성장으로 이동량이 늘 때 교통 부담이 어떻게 달라지는지 관찰합니다.',
    color: 0xfacc15,
  },
  {
    id: 'environment',
    title: '환경 기준의 필요성',
    icon: '🌿',
    description: '지역 회복 과정에서도 환경과 오염을 함께 관리해야 한다는 점을 확인했다.',
    nextActionLabel: 'EP3 성장 관점',
    nextAction: 'EP3에서는 산업 성장의 경제 효과와 환경 부담이 함께 나타나는지 관찰합니다.',
    color: 0x4ade80,
  },
  {
    id: 'budget_balance',
    title: '투자 효과의 비교',
    icon: '💰',
    description: '제한된 예산 안에서 주민 생활에 도움이 되는 조합을 비교해야 함을 확인했다.',
    nextActionLabel: 'EP3 성장 관점',
    nextAction: 'EP3에서는 산업 시설의 비용과 경제 효과, 생활 부담을 함께 비교합니다.',
    color: 0xfb7185,
  },
];
...
export const EPISODE_CONTENT = Object.freeze({
  ...
  [EPISODE_IDS.PopulationRecovery]: Object.freeze({
    ...
    reflectionChoices: EP2_REFLECTION_CHOICES,
