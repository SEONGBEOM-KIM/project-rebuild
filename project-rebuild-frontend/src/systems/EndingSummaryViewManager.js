  ...
  static getControlLayout(centerX, placementEpisodeId = null) {
    ...
    return {
      ...
      next: {
        x: centerX,
        y: 955,
        label: hasNextEpisode ? '다음 에피소드' : '학습 마무리',
        target: hasNextEpisode ? SCENE_KEYS.EpisodeTransition : SCENE_KEYS.Boot,
        backgroundColor: hasNextEpisode ? '#bbf7d0' : '#fde68a',
        textColor: '#123524',
      },
      restart: { x: centerX + 360, y: 955, label: '처음부터 다시', target: SCENE_KEYS.Boot, backgroundColor: '#fca5a5', textColor: '#450a0a' },
    };
  }
}
